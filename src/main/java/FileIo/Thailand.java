...
//       String filepath= "F:\\img\\泰国测试样本\\6560-FAC-1901210093.jpg";
//       String OCR_filepath="F:\\img\\泰国测试样本\\OCR.xls";
//       String SAP_filepath="F:\\img\\泰国测试样本\\SAP.xls";
...
//            }
//            //对于数据无法清洗的字段进行过滤和筛选
//            List<DataDO> dataDOS_OCR = new ArrayList<>();
//            List<DataDO> dataDOS_ASP = new ArrayList<>();
//            for (DataDO dataDO : dataDOList1) {
...
//                //生成SAP表
//                thailand.excelOutput_SAP(dataDOS_ASP, SAP_filepath);
//            }
//            //生成OCR表
//             thailand.excelOutput_OCR(dataDOS_OCR, OCR_filepath);
//        } else {
//            List<DataDO> dataDOList = new ArrayList<>();
...
//            dataDO.setOCRStatus("未找到基准点坐标");
//            dataDOList.add(dataDO);
//            thailand.excelOutput_OCR(dataDOList, OCR_filepath);
//        }
//    }
//
...
//            if ("6560-FAC".equals(dataDO.getCompanyCode())) {
//                row1.createCell(12).setCellValue("THB");
//            } else if ("62F0-FAC".equals(dataDO.getCompanyCode())) {
